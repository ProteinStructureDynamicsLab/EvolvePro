...
def setup_distributed():
    # Set up single-process distributed environment
    os.environ["RANK"] = "0"  # Rank of this process (single process, rank=0)
    os.environ["WORLD_SIZE"] = "1"  # Total number of processes (1 for single GPU)
